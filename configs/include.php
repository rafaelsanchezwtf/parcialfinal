...
define('C_FULL_PATH', 'C:/xampp/htdocs/parcialfinal/'); //full path

define('C_L_GLOBAL', 'http://localhost/parcialfinal/'); //application global link
...
define('C_DB_DATABASE_NAME', 'parcial_final'); //DB database name
